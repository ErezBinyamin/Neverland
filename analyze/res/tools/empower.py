...
def category_analysis(filepath):
  ...
  categories_mapping = {
      ...
      "Healthcare":["Healthcare", "Medical", "Med Dep", "Pharmacy", "Dental", "ajh-", "Jaques", "Anna Jaques", "doctor", "physician", "consultation", "radiology", "appointment", "clinic", "hospital", "surgery", "procedure", "medication", "pharmacy", "prescription", "diagnostic", "laboratory", "x-ray", "MRI", "CT scan", "treatment", "therapy", "physical therapy", "chiropractor", "acupuncture", "dentist", "dental", "vision", "optometrist", "eye care", "glasses", "contact lenses", "surgery", "operation", "health insurance", "medical insurance", "co-pay", "deductible", "ambulance", "urgent care", "emergency room", "hospitalization", "nurse", "nursing", "home care", "mental health", "psychiatrist", "psychologist", "counseling", "psychotherapy", "substance abuse", "addiction", "rehab", "prescription drug", "inpatient", "outpatient", "vaccine", "vaccination", "immunization", "blood test", "lab work", "medical supplies", "prosthesis", "wheelchair", "hearing aid", "medical equipment", "syringe", "bandages", "surgery", "blood pressure", "insulin", "glucose test", "diabetes", "eating disorder", "weight loss", "heart condition", "cardiologist", "cardiology", "oncologist", "cancer treatment", "chemotherapy", "radiation", "nursing home", "palliative care" ],
